...
type Lista[T any] interface {
	...
	// Iterar recorre toda la lista aplicando la funcion visitar elemento a elemento hasta que finaliza la misma o hasta que visitar devuelva false.
	Iterar(visitar func(T) bool)

	// Iterador se encarga de inicializar el iterador externo en la primera posicion de la lista (el usuario es el encargado de realizar la iteracion a conveniencia).
...
type IteradorLista[T any] interface {
	...
	// Siguiente mueve la posicion actual del iterador a la del siguiente elemento. Si no hay siguiente elemento entra en panico
	...
	// Borrar elimina el elemento de la posicion actual del iterador. Si la lista no tiene elementos entra en panico con un mensaje "La lista esta vacia""
	Borrar() T
}
